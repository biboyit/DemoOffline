...
define(["i18n!nls/labels", "Backbone", "tpl", "BaseView", "views/LanguageListView", "config"], function (i18n, Backbone, tpl, BaseView, LanguageListView, cfg) {

    // Extends Backbone.View
    var LanguageView = BaseView.extend({

        languageListSelector: 'ul#LanguageList',
        
        initialize: function (options) {
            this.hideMenuPanel = options.hideMenuPanel || false;

            this.template = _.template(tpl.get('language'));
        ...
        render: function () {
            ...
            this.listView = new LanguageListView({ el: $(this.languageListSelector, this.el), model: this.model });
        ...
        clearSearch: function (event) {
            var filter = $("ul#languageList").prev().children(".ui-input-search").children("input");
            filter.val("");
